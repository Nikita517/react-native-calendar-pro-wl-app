...
export const textDefaultColor = '#004CA1';
export const textColor = '#E60A0A';
export const textLinkColor = '#004CA1';
export const textTodayColor = '#E60A0A';

export const textDayFontFamily = 'SFNS';
...
export const todayTextColor = '#E60A0A';
...
export const agendaTodayColor = '#E60A0A';
export const agendaKnobColor = '#f2F4f5';
export const todayButtonTextColor = '#E60A0A';
